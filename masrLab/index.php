...
//$sql_fetch= "SELECT * FROM patients";

if(isset($_POST['submit'])){
    $p_id=$_POST['patient-id'];
    $_SESSION['message']=$p_id;
...
<body>
    ...
    <!-- Brand Start -->
    <div class="container-fluid text-white pt-4 pb-5 d-none d-lg-flex bg-primary" >
    ...
    <div class="container-fluid sticky-top " dir="rtl">
        <div class="container">
            <nav class="navbar navbar-expand-lg navbar-light bg-white py-lg-0 px-lg-3 " style="border-radius: 10px;">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <div class="navbar-nav">
                        <a href="./admin.php" class="nav-item nav-link ">تسجيل دخول</a>
                        <a href="./result.php" class="nav-item nav-link ">النتيجه</a>
                        <a href="#top" class="nav-item nav-link ">الرئيسية</a>
    ...
    <!-- Carousel Start -->
    <div class="container-fluid header-carousel px-0 mb-5 position-relative " dir="rtl">
                        ...
                        <div class="container">
                            <div class="row justify-content-start align-items-center">
                                <div class="col-lg-7 text-start">
                                    <h1 class="display-1 text-white animated slideInRight mb-3">دقة تمنحك الثقة</h1>
                                    <p class="mb-5 animated slideInRight">بوجود احدث الاجهزة المعملية نضمن الدقة الكاملة في النتائج</p>
                                    <form method="POST" action="index.php" class="d-flex flex-column align-items-center justify-content-center animated slideInRight" >
                                        <input type="submit" name="submit" class="btn btn-primary py-3 px-5 mb-3 " style="border-radius: 20px;" value='الحصول علي النتيجة'>
                                        <input type="text" name="patient-id" class="input" pattern="\d+" placeholder="رقم الحالة...">
                                    </form>
                                </div>
                        ...
                        <div class="container">
                            <div class="row justify-content-end">
                                <div class="col-lg-7 text-end">
                                    <h1 class="display-1 text-white animated slideInLeft mb-3">فريق متميز من الاطباء</h1>
                                    <p class="mb-5 animated slideInLeft">فريق متميز من الاطباء يعمل علي مدار الساعة لخدمتكم</p>
                                    <form method="POST" action="index.php" class="d-flex flex-column align-items-center justify-content-center animated slideInRight" >
                                        <input type="submit" name="submit" class="btn btn-primary py-3 px-5 mb-3 " style="border-radius: 20px;" value='الحصول علي النتيجة'>
                                        <input type="text" name="patient-id" class="input" pattern="\d+" placeholder="رقم الحالة...">
                                    </form>
        ...
        <!-- --------------animation----------------- -->
        <div class="position-absolute " style="top:100px; right:50%; z-index: 3;">
            <div class="svg-frame   z-3 ">
                <svg style="--i:0;--j:0;">
                    <g id="out1">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-6">
                            <div class="bg-primary w-100 h-100 mt-n5 ms-n5 d-flex flex-column align-items-center justify-content-center">
                                ...
                                <h1 class="display-1 text-white mb-0" data-toggle="counter-up">+6</h1>
                                <small class="fs-5 text-white">سنوات خبرة</small>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.5s" dir="rtl">
                    <h1 class="display-6 mb-4">فريق متميز من الاخصائيين المعتمدين من نقابة الاطباء</h1>
                    <p class="mb-4">يتميز معمل مصر لاب بوجود احدث الأجهزة المعملية و فريق متميز من الاخصائيين و ذلك لضمان دقة النتائج</p>
                    <div class="row g-4 g-sm-5 justify-content-center">
                        <div class="col-sm-6">
                            <div class="about-fact btn-square flex-column rounded-circle bg-primary ms-sm-auto">
                                <p class="text-white mb-0">عدد الزوار الدائمين</p>
                                <h1 class="text-white mb-0" ><span class="text-white" data-toggle="counter-up">500</span>+</h1>
                            </div>
                        </div>
                        <div class="col-sm-6 text-start">
                            <div class="about-fact btn-square flex-column rounded-circle bg-secondary me-sm-auto">
                                <p class="text-white mb-0">عدد النتائج و الحالات</p>
                                <h1 class="text-white mb-0" ><span class="text-white" data-toggle="counter-up">1000</span>+</h1>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="about-fact mt-n130 btn-square flex-column rounded-circle bg-dark mx-sm-auto">
                                <p class="text-white mb-0">عملاء متميزون</p>
                                <h1 class="text-white mb-0"><span class="text-white" data-toggle="counter-up">300</span>+</h1>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <!-- Features Start -->
    <div id="features" class="container-fluid py-5" dir="rtl">
        <div class="container">
            <div class="row g-0 feature-row">
                <div class="f-col col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
                    <div class="feature-item border h-100 p-5">
                        <div class="icon-box-primary mb-4">
                            <i class="bi bi-award text-dark"></i>
                        </div>
                        <h5 class="mb-3">دقة كاملة</h5>
                        <p class="mb-0">شعارنا : دقة تمنحك الثقة</p>
                    </div>
                </div>
                <div class="f-col col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.3s">
                    <div class="feature-item border h-100 p-5">
                        <div class="icon-box-primary mb-4">
                            <i class="bi bi-people text-dark"></i>
                        </div>
                        <h5 class="mb-3">اطباء متخصصون</h5>
                        <p class="mb-0">فريق كامل من الاطباء المعتمدين</p>
                    </div>
                </div>
                <div class="f-col col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.5s">
                    <div class="feature-item border h-100 p-5">
                        <div class="icon-box-primary mb-4">
                            <i class="bi bi-cash-coin text-dark"></i>
                        </div>
                        <h5 class="mb-3">اسعار لا تقبل المنافسة</h5>
                        <p class="mb-0">ادق النتائج بأقل الاسعار و خصومات خاصة طوال العام</p>
                    </div>
                </div>
                <div class="f-col col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.7s">
                    <div class="feature-item border h-100 p-5">
                        <div class="icon-box-primary mb-4">
                            <i class="bi bi-headphones text-dark"></i>
                        </div>
                        <h5 class="mb-3">معك دائما</h5>
                        <p class="mb-0">خدمة 24 ساعة حيث يمكنك حجز مواعيد و الاستفسار في اي وقت</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- Service Start -->
    <div id="services" class="container-fluid container-service py-5" dir="rtl">
        <div class="container pt-5">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <h1 class="display-6 mb-3">خدمات معملية مميزة و موثوقة</h1>
                <p class="mb-5">معمل مصر لاب يقدم افضل الخدمات المعملية و بأدق النتائج علي ايدي اطباء متخصصين</p>
            </div>
            <div class="row g-4">
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item">
                        ...
                        <h5 class="mb-3">باثولوجي</h4>
                            <p class="mb-4">اختبارات عينات باثولوجي باحدث الاجهزة </p>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item">
                        ...
                        <h5 class="mb-3">ميكرو بيولوجي</h4>
                            <p class="mb-4">اختبارات ميكروبيولوجي بأحدث الاجهزة </p>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item">
                        ...
                        <h5 class="mb-3">الكيمياء الحيوية</h4>
                            <p class="mb-4">اختبارات الكيمياء الحيوية تتم بافضل الخامات الكيميائية</p>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="service-item">
                        ...
                        <h5 class="mb-3">هيستو باثولوجي</h4>
                            <p class="mb-4">الفحص المجهري للأنسجة وذلك بهدف دراسة مُتغيرات المرض.</p>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item">
                        ...
                        <h5 class="mb-3">البول</h4>
                            <p class="mb-4">الفحص المجهري لعينات البول للكشف عن الامراض</p>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item">
                        ...
                        <h5 class="mb-3">الدم</h4>
                            <p class="mb-4">باستخدام احدث الاجهزة لاجراء فحوصات الدم لتشخيص العديد من الامراض</p>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item">
                        ...
                        <h5 class="mb-3">الحمي</h4>
                            <p class="mb-4">الفحص المجهري و الكيميائي للكشف عن الحمي و اسبابها</p>
                ...
                <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="service-item">
                        ...
                        <h5 class="mb-3">الحساسية</h4>
                            <p class="mb-4">الفحص المجهري  و الكيميائي لتشخيص اسباب الحساسية</p>
    ...
    <!-- Service End -->
     ...
     <!-- contact Start -->
    <div id="contact" class="container-fluid py-5" id="contact">
        <div class="container py-5">
            <div class="text-center mx-auto wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                <h1 class="display-6 mb-3">لديك استفسار ؟ اتصل بنا الان</h1>
                <p class="mb-5"></p>
            </div>
                ...
                <div class="col-lg-6">
                    <a href="tel:+0123456789" class="d-flex justify-content-lg-center bg-primary p-4">
                        ...
                        <div class="ms-3">
                            ...
                            <h2 class="text-white mb-0">01092390392</h2>
                        </div>
                    </a>
                </div>
                <div class="col-lg-6">
                    <a href="mailto:info@example.com" class="d-flex justify-content-lg-center bg-primary p-4">
                        ...
                        <div class="ms-3">
                            ...
                            <h2 class="text-white mb-0">elsayedshams3@gmail.com</h2>
                        </div>
                    </a>
                </div>
            </div>
            <div class="row g-5">
                ...
                <div class="col-lg-12 wow fadeInUp d-flex justify-content-center" data-wow-delay="0.5s" style="border:4px solid rgb(216, 210, 210)">
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d214.3612117300544!2d31.123914258455024!3d30.7246018424241!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14f7c548c7700ed7%3A0x1c604e9ac9397d5d!2z2YXYtdixINmE2KfYqA!5e0!3m2!1sen!2sbd!4v1704125137251!5m2!1sen!2sbd" width="1000" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Team Start -->
    <div id="team" class="container-fluid container-team py-5" dir="rtl">
        <div class="container pb-5">
            <div class="row g-5 align-items-center mb-5">
                <div class="col-md-6 wow fadeIn" data-wow-delay="0.3s">
                    <img class="img-fluid w-75" src="img/team-1.jpeg"  alt="">
                </div>
                <div class="col-md-6 wow fadeIn" data-wow-delay="0.5s">
                    <h1 class="display-6 mb-3">د/ يمنى مجدي سراج الدين</h1>
                    <p class="mb-1">الطبيب المعتمد</p>
                    <p class="mb-5">السنطة-محافظة الغربية</p>
                    <h3 class="mb-3">نبذة :</h3>
                    <p class="mb-4">
                        <ol>
                            <li>خبرة اكثر من 8 سنوات في اجراء الفحوصات و الاختبارات المعملية</li>
                            <li>القدرة علي التعامل مع كافة الاجهزه المعملية</li>
                            <li>تتميز بخفة اليد فيما يتعلق بسحب عينات الدم</li>
                        </ol>
                    </p>

                    <p class="mb-4">
                        <h3 class="mb-3">المؤهلات العلمية :</h3>
                        <ol>
                            <li> حاصل علي شهادة البكالوريوس من كلية العلوم جامعة طنطا</li>
                            <li>حاصل علي دبلومة الميكروبيولجي من جامعه عين شمس</li>
                            <li> حاصل علي دبلومة الكيمياء الحيوية من جامعة شبين</li>
    ...
    <!-- Testimonial Start -->
    <div id="testimonial" class="container-fluid testimonial py-5" dir="rtl">
        <div class="container pt-5">
            <div class="row gy-5 gx-0">
                <div class="col-lg-6 pe-lg-5 wow fadeIn" data-wow-delay="0.3s">
                    <h1 class="display-6 text-white mb-4">ماذا يقول عملاؤنا عنا ! </h1>
                    <p class="text-white mb-5">نتمتع بالشفافية الكاملة في عرض اراء عملاؤنا </p>
                </div>
                <div class="col-lg-6 mb-n5 wow fadeIn" data-wow-delay="0.5s">
                    <div class="bg-white p-5">
                        <div class="owl-carousel testimonial-carousel wow fadeIn" data-wow-delay="0.1s" dir="ltr">
                            <div class="testimonial-item">
                                <div class="icon-box-primary mb-4">
                                    <i class="bi bi-chat-left-quote text-dark"></i>
                                </div>
                                <p class="fs-5 mb-4">معمل مصر لاب من افضل المعامل في السنطة و دكتورة يمنى متميزة في النتائج وسحب العينات</p>
                                <div class="d-flex align-items-center">
                                    <img class="flex-shrink-0" src="img/testimonial-2.jpg" alt="">
                                    <div class="ps-3">
                                        <h5 class="mb-1">السيد شمس الدين</h5>
                                        <span class="text-primary">مهندس</span>
                                    </div>
                                </div>
                            </div>
                            <div class="testimonial-item">
    ...
    <!-- Footer Start -->
    <div class="container-fluid footer position-relative bg-dark text-white-50 py-5 wow fadeIn" data-wow-delay="0.1s" dir="rtl">
        <div class="container">
            <div class="row g-5 py-5">
                <div class="col-lg-6 pe-lg-5" dir="ltr">
                    <a href="index.html" class="navbar-brand">
                        <h1 class="h1 text-primary mb-0">Masr<span class="text-white">Lab</span></h1>
                    </a>
                    <p class="fs-5 mb-4">للتواصل مع معمل مصر لاب و اي استفسار اخر برجاء التواصل علي :</p>
                    <p><i class="fa fa-map-marker-alt me-2"></i>السنطة-برج هدهود-اعلى قاعة كزي</p>
                    <p><i class="fa fa-phone-alt me-2"></i>01092390392</p>
                    <p><i class="fa fa-envelope me-2"></i>elsayedshams3@gmail.com</p>
                ...
                <div class="col-lg-6 ps-lg-5" dir="ltr">
                    <div class="row g-5">
                        <div class="col-sm-6">
                            <h4 class="text-light mb-4">روابط مفيدة</h4>
                            <a class="btn btn-link" href="#about">نبذه عنا</a>
                            <a class="btn btn-link" href="#contact">تواصل معنا</a>
                            <a class="btn btn-link" href="#services">الخدمات</a>
                            <a class="btn btn-link" href="#top">الشروط و الاحكام</a>
                            <a class="btn btn-link" href="#top">الدعم</a>
                        </div>
                        <div class="col-sm-6">
                            <h4 class="text-light mb-4">الروابط الاكثر زيارة</h4>
                            <a class="btn btn-link" href="#top">الحصول علي النتيجة</a>
                            <a class="btn btn-link" href="#contact">تواصل معنا</a>
                            <a class="btn btn-link" href="#testimonial">اراء عملاؤنا</a>
                            <a class="btn btn-link" href="#top">الشروط و الاحكام</a>
                            <a class="btn btn-link" href="#top">الدعم</a>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 text-center text-md-start">
                    <p class="mb-0">&copy; <a href="#">MasrLab-مصر لاب</a>. All Rights Reserved.</p>
                </div>
                <div class="col-md-6 text-center text-md-end">
                    <p class="mb-0">Designed & Distributed by <a href="#">ُElsayed Shams Eldeen</a></p>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- Back to Top -->
    <a href="#top" class="btn btn-lg btn-primary btn-lg-square rounded-circle back-to-top"><i class="bi bi-arrow-up"></i></a>
